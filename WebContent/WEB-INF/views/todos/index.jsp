    ...
    <c:param name="content">
        <ul>
            <c:forEach var="todo" items="${todos}">
                <li>
                     ...
                     <span class="typename"> <c:out  value="${todo.gettypename()}" /> </span>
                     <button  class="buttonclass" type="submit">内容変更</button>
                     <input class="buttonclass" type= "button" value="削除" onclick ="location.href='${pageContext.request.contextPath}/destroy?id=${todo.id}&selecttype=${selecttype}'">
        ...
        <form method="POST" action="${pageContext.request.contextPath}/todoindex2">
        	<div>
         		...
         		<label for="typechoice2">1:仕事</label>

   				 <input type="radio" id="type2"name="type" value="2">
                <label for="typechoice3">2:プライベート</label>
		   </div>
  			<div>
